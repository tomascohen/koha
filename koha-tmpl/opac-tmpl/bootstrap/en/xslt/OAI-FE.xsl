	...
	<xsl:template match="/">
		<html>
			<head>
                ...
                <script src="/opac-tmpl/bootstrap/lib/jquery/jquery.js" type="text/javascript"></script>
                <script src="/opac-tmpl/bootstrap/lib/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>

                <link rel="stylesheet" href="/opac-tmpl/bootstrap/css/style-oai.css" type="text/css" />
			</head>
			<body>
                <div class="container">
